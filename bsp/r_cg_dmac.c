...
void R_DMAC0_Create(void)
{
    ...
    DMAPR10 = 1U;
    DMAPR00 = 1U;
    DMC0 = _40_DMA_TRANSFER_DIR_RAM2SFR | _00_DMA_DATA_SIZE_8 | _00_DMA_TRIGGER_SOFTWARE;
    DSA0 = _10_DMA0_SFR_ADDRESS;
    DRA0 = _D380_DMA0_RAM_ADDRESS;
    DBC0 = _0008_DMA0_BYTE_COUNT;
