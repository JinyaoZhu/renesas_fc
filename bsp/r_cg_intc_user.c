...
#define PWM_IN_TIMER_MAX_CNT   (_EA5F_TAU_TDR06_VALUE)
/* End user code. Do not edit comment generated here */
...
#define SONAR_ECHO P13.7

volatile uint16_t ch1_width = 0;
volatile uint16_t ch2_width = 0;
volatile uint16_t ch3_width = 0;
volatile uint16_t ch4_width = 0;
volatile uint16_t ch5_width = 0;
volatile uint16_t ch6_width = 0;
volatile uint16_t ch7_width = 0;
volatile uint16_t ch8_width = 0;

volatile uint16_t sonar_start_cnt = 0;
volatile uint16_t sonar_width = 0;
volatile uint16_t sonar_get_flag = 0;
...
__interrupt static void r_intc6_interrupt(void)
{
    ...
    uint16_t cnt = TCR06;
    uint16_t width;
    static uint16_t last_cnt = 0xffff;
    static uint16_t ch = 1;
    EI();
    
    if (cnt > last_cnt)
        width = PWM_IN_TIMER_MAX_CNT - cnt + last_cnt + 1;
      else
        width = last_cnt - cnt;
